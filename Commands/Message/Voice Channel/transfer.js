...
module.exports = {
    ...
    aliases: [ "tf" ],
    description: "Transfer your channel creator.",
    args: true,
...
"773708964482252840", "773788687519580200", "773723655346585630", "773723765661630464", "773788693348483072");
        ...
        getSecondaries.ChannelCreator = member.id;
        getSecondaries.save(async (err, data) => {
            ...
            embed.setDescription(`<a:yes:893059568383438868> | Berhasil memindahkan Kepemilikan voice channel anda kepada ${member}.`);
            message.channel.send({ embeds: [embed] });
            await logs(message, memberVC, "Transfer", `${message.author.tag} [\`${message.author.id}\`]`, `${member.tag} [\`${member.id}\`]`);
        });
